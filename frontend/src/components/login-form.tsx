      ...
      <form>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-blue-900">Welcome to Stockify</h1>
            <div className="text-center text-sm">
              Don&apos;t have an account?{" "}
              <a href="#" className="underline underline-offset-4 text-blue-700 hover:text-blue-900">
                Sign up
              </a>
            </div>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <Button variant="outline" type="button" className="w-full border-blue-200 text-blue-700 hover:bg-blue-50 hover:text-blue-900">
