...
// Common theme-aware color classes - Updated for better dark mode
export const themeColors = {
  ...
  status: {
    ...
    successBg: "bg-success/10 text-success",
    error: "text-destructive",
    errorBg: "bg-destructive/10 text-destructive",
    warning: "text-warning",
    warningBg: "bg-warning/10 text-warning-foreground",
    info: "text-primary",
    infoBg: "bg-primary/10 text-primary",
  },
